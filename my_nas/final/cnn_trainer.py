...
from my_nas.final.base import FinalTrainer
# from my_nas.final.bnn_model import BNNGenotypeModel
from my_nas.utils.common_utils import nullcontext
from my_nas.utils.exception import expect
from my_nas.utils import DataParallel
from my_nas.utils import DistributedDataParallel
from my_nas.utils.torch_utils import calib_bn, GroupSampler, DistributedGroupSampler
from my_nas.utils.parallel_utils import get_dist_info
    ...
    def _load_state_dict(self, path):
        ...
        if missing_keys:
            self.logger.error(("{} missing keys will not be loaded! Check your genotype, "
                               ...
                               " `mynas eval-arch --save-state-dict` in an old version, "
