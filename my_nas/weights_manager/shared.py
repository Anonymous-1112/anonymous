...
from my_nas.weights_manager.base import BaseWeightsManager
from my_nas.weights_manager.wrapper import BaseBackboneWeightsManager
from my_nas.utils.common_utils import Context
...
class SharedNet(BaseBackboneWeightsManager, nn.Module):
    ...
    def forward(self, inputs, genotypes, **kwargs): #pylint: disable=arguments-differ
        ...
        # we do not reuse my_nas.weights_manager.wrapper.ClassificationHead
