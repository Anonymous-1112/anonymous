...
try:
    ...
    _LOGGER.warn(
        ("Cannot import module nasbench_301: {}\n"
         "Should install the NASBench 301 package to use NB301Evaluator (gt perfs)"
         " following https://github.com/automl/nasbench301. "
         "However, if only supernet training / arch evaluation are needed, there is "
         "no need to install it."
        ).format(e))

from my_nas.evaluator.base import BaseEvaluator
from my_nas.common import CNNSearchSpace
from my_nas.rollout.base import Rollout
