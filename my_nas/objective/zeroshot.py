...
try:
    from my_nas.objective.zerocost import get_measures
except ImportError as e:
    utils.getLogger("objective.zeroshot").warn(
        ("Cannot import `get_measures` from `my_nas.objective.zerocost`, zeroshot objectives cannot work normally! {}\n"
         "\tSee instructions/README.md for more information").format(e))
