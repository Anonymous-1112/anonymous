...
from my_nas import ops, germ
from my_nas.utils import nullcontext
from .utils import *
from my_nas.utils.common_utils import _get_channel_mask, _get_feature_mask
...
class GermMixedOp(germ.SearchableBlock):
    ...
    def __init__(self, ctx, op_list, op_choice=None, **op_kwargs):
        ...
        # if it is a string, the class would be got by calling `my_nas.ops.get_op`
