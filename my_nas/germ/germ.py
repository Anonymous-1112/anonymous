...
from my_nas.common import BaseRollout, SearchSpace
from my_nas.utils import expect, ConfigException
...
class DecisionList(SearchableBlock):
    ...
    :class:`~my_nas.germ.DecisionList` can be indexed like a regular Python list, but
