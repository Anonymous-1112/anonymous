...
from my_nas.common import Rollout, assert_rollout_type
from my_nas.controller.base import BaseController
from my_nas.controller.rl_networks import BaseRLControllerNet
from my_nas.controller.rl_agents import BaseRLAgent
...
class RLController(BaseController, nn.Module):
    ...
    def __init__(self, search_space, device, rollout_type="discrete",
        ...
        """
        Args:
            search_space (my_nas.SearchSpace): The controller will sample arch seeds
