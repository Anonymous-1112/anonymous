...
from my_nas import assert_rollout_type
from my_nas.controller.base import BaseController
from my_nas.rollout.ofa import MNasNetOFARollout, genotype_from_str
...
class HardwareOFAController(OFAController):
    ...
    def sample(self, n=1, batch_size=1):
        if self.mode == "eval":  # in my_nas derive
            rollouts = []
            ...
            return rollouts
        elif self.mode == "train":  # in my_nas search
