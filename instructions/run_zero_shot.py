...
data_shuffle_indices_files = [
    None,
    # "/home/eva_share_users/Anonymous/surgery/nb201/zero_shot/shuffle2020.yaml",
    # "/home/eva_share_users/Anonymous/surgery/nb201/zero_shot/shuffle202020.yaml"
]
...
def _worker(p_id, gpu_id, queue):
    while 1:
        ...
        cmd = (
            "mynas eval-arch {} {} {} --steps {} --gpu {} --reset-dataloader-each-rollout"
            " --dump-rollouts {} >{} 2>&1"
        ).format(
            eval_cfg_fname,
            args.arch_file,
